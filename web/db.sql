...
--
-- Host: localhost    Database: pharma_link
-- ------------------------------------------------------
...
CREATE TABLE `delivery` (
  ...
  PRIMARY KEY (`medication`, `patient`),
  KEY `fkDeliveryPatient` (`patient`),
  CONSTRAINT `fkDeliveryMedication` FOREIGN KEY (`medication`) REFERENCES `medication` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
;
-- Dump completed on 2023-11-12 10:12:23