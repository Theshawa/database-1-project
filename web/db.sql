...
CREATE TABLE `delivery_medication` (
  ...
  KEY `fkDeliveryMedicationDelivery` (`delivery`),
...
DROP TABLE IF EXISTS `direct_purchase_medication`;
/*!40101 SET @saved_cs_client     = @@character_set_client */
;
/*!50503 SET character_set_client = utf8mb4 */
;
CREATE TABLE `direct_purchase_medication` (
  `direct_purchase` int NOT NULL,
  `medication` int NOT NULL,
  `qty` float NOT NULL,
  PRIMARY KEY (`direct_purchase`, `medication`),
  KEY `fkDirectPurchaseMedicationMedication` (`medication`),
  KEY `fkDirectPurchaseMedicationDirectPurchase` (`direct_purchase`),
  CONSTRAINT `fkDirectPurchaseMedicationDirectPurchase` FOREIGN KEY (`direct_purchase`) REFERENCES `direct_purchase` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fkDirectPurchaseMedicationMedication` FOREIGN KEY (`medication`) REFERENCES `medication` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
-- Dumping data for table `direct_purchase_medication`
--

LOCK TABLES `direct_purchase_medication` WRITE;
/*!40000 ALTER TABLE `direct_purchase_medication` DISABLE KEYS */
;
/*!40000 ALTER TABLE `direct_purchase_medication` ENABLE KEYS */
;
UNLOCK TABLES;
--
